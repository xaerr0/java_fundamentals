...
// Only pick 2. Create class for each. The class will need to model the data. All columns need a variable.
// Create a database connection class with all database connection inside.
// Create another class called just database. Inside declare a database connection object. All methods inside this class.
// In main method just declare a database class and call its methods.
