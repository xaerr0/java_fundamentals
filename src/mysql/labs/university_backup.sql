...
INSERT INTO `courses` VALUES (1,'computer science',3),(2,'literature',3),(3,'design',3),(4,'bowling',6),(5,'interpretive dancing',5),(6,'math',1);
...
INSERT INTO `students` VALUES (1,'ryan','desmond','ryan@codingnomads.co',35),(2,'kim','desmond','kim@codingnomads.co',35),(3,'martin','breuss','martin@codingnomads.co',46),(4,'caden','mackenzie','caden@codingnomads.co',4),(5,'matt','tress','mattress@codingnomads.co',78);
...
INSERT INTO `teachers` VALUES (1,'billy','rubin','interpretive dancing'),(2,'foster ','child','design'),(3,'sue','flay','computer science'),(4,'jo','king','literature'),(5,'harry','rump','bowling'),(6,'al','dente','math'),(7,'armand','hammer','math'),(8,'lou','zar','math'),(9,'don','key','tree climbing');
...
INSERT INTO `teachers_students` VALUES (1,5,3),(2,4,2),(3,2,5),(4,1,1),(5,3,2),(6,4,6),(7,1,8),(8,5,7);
...
-- Dump completed on 2022-10-18 11:05:36
