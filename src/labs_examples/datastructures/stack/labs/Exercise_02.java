 ...
 *
 *      1) throw a custom exception when trying to pop an element from an empty Stack x
 *
 ...
 *      4) contain the methods peekFirst() and peekLast() x
 *      5) contain a size() method x
 *      6) contain a method to print out the data of all elements in the Stack x
 *
